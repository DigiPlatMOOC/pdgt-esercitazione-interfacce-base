...
output >> divina_commedia.txt  README.md

il file più piccolo è "README.md"
```
...
```bash
curl https://raw.githubusercontent.com/DigiPlatMOOC/pdgt-esercitazione-interfacce-base/master/2-processi/README.md | grep "Consegna" -w --after-context=40
```
