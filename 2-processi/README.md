...
```bash
cat divina_commedia.txt | grep -c "stelle"
```
...
```bash
curl https://raw.githubusercontent.com/DigiPlatMOOC/pdgt-esercitazione-interfacce-base/master/2-processi/README.md | grep -A 100 "minuscole."
```
