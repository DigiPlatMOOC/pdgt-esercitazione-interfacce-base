...
```bash
cat divina_commedia.txt | tail -1
```
...
```bash
curl https://raw.githubusercontent.com/DigiPlatMOOC/pdgt-esercitazione-interfacce-base/master/2-processi/README.md | grep -E '[###-```bash]'
```
